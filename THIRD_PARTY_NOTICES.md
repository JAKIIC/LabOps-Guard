...
confirmed. The project removed those bytes from the current `main` tree before the source release.
Git history and immutable AT-001 output retain the audit record and historical hashes; neither forms
an active Release fixture. Current compatibility tests use
`demo/fixtures/project_snapshot_synthetic/`, which LabOps Guard contributors created and licensed
under Apache-2.0. See `docs/public-repository-hygiene-audit.md` for the decision record.
